module.exports = function(){
    ...
    function getPeople(res, mysql, context, complete){
        ...
        mysql.pool.query("SELECT students.id as id, fname, lname, houses.name AS house, students.class_year as year FROM students INNER JOIN houses ON homeworld = houses.id", function(error, results, fields){
