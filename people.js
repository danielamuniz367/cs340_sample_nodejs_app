module.exports = function(){
    ...
    function getPeople(res, mysql, context, complete){
        ...
        mysql.pool.query("SELECT students.id as id, fname, lname, type, class_year, houses.name as house FROM students INNER JOIN houses on house_id = houses.id", function(error, results, fields){
